...
def menu_vectorizacion():
    ...
    # descomenta cuando hayas implementado calcular_iva_todos
    ...
    # descomenta cuando hayas implementado calcular_valor_con_iva
    con_iva = calcular_valor_con_iva(VALORES_DECLARADOS)
    print(f"\n  Primeros 3 valores con IVA: {con_iva[:3]}")

    # descomenta cuando hayas implementado redondear_a_miles
...
def menu_ufuncs():
    ...
    # descomenta cuando hayas implementado calcular_variacion_absoluta
...
def menu_boolean_arrays():
    ...
    # descomenta cuando hayas implementado obtener_mascara_mora
    mascara = obtener_mascara_mora(DIAS_MORA)
    print(f"\n  Máscara de mora: {mascara}")
    print(f"  Registros en mora: {np.sum(mascara)} de {len(mascara)}")

    # descomenta cuando hayas implementado filtrar_valores_con_mora
    ...
    # descomenta cuando hayas implementado contar_sobre_umbral
    umbral = 1_000_000
